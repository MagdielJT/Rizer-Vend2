...
const accountSettings = {
  ...
  consumerSecret: '181ecea54bfa7e97fdb09eaa110ccbb72a73cfa18d9ca5b807b1d68c0448fd6a-andy',
};
const urlSettings = {
  ...
  return new Promise((resolve, reject) => {
    connection
      ...
      .then((body) => {
        ...
        setTimeout( function () { resolve(body) }, getRandom(5000, 1000));
      })
      .catch((error) => {
        reject(error);
      });
